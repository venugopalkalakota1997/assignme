...
let AddarticleComponent = class AddarticleComponent {
    constructor(router, formBuild, authService, _userService) {
        this.router = router;
...
let UserService = class UserService {
    ...
    getarticles() {
        ...
        return this._httpClient.get(this.articleurl, { headers });
    }
    userSignUp(userSignUpData) {
        //alert(JSON.stringify(userSignUpData))
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
        headers = headers.set('Authorization', 'Bearer ' + this._authService.getToken());
        return this._httpClient.post(this.adduserUrl + '/addUser', userSignUpData, { headers });
    }
    addArticle(article) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
        headers = headers.set('Authorization', 'Bearer ' + this._authService.getToken());
        // alert(JSON.stringify(article))
        return this._httpClient.post(this.addarticleUrl, article, { headers });
    }
};
...
let UserSignupComponent = class UserSignupComponent {
    constructor(formBuilder, _authService, _userService, _datepipe) {
